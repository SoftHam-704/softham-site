...
// SalesMasters Highlight Section - Premium CTA
const SalesMastersHighlight = () => {
  const { ref, isVisible } = useIntersectionObserver();
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-[#0a0a0a]">
      ...
      {/* Floating elements */}
      <div className="absolute top-1/4 left-10 w-32 h-32 border border-[#00ff88]/10 rotate-45 animate-pulse" />
      <div className="absolute bottom-1/4 right-10 w-24 h-24 bg-[#00ff88]/5 rounded-full blur-xl" />
        ...
        <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}>
          ...
          <div className={`transform transition-all duration-700 delay-100 ${isVisible ? "translate-x-0" : "-translate-x-20"}`}>
            <div className="flex items-center gap-3 mb-6">
              <span className="text-[10px] px-3 py-1.5 bg-[#00ff88] text-[#0a0a0a] font-black tracking-wider rounded">
                ★ EM DESTAQUE
              </span>
              <div className="h-px flex-1 bg-gradient-to-r from-[#00ff88]/30 to-transparent" />
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[0.9] tracking-tight mb-6">
              <span className="text-[#00ff88]">SALESMASTERS</span>
              <br />
              <span className="text-white/80">REPRESENTAÇÃO</span>
              <br />
              <span className="text-white/40 text-2xl md:text-3xl">COMERCIAL</span>
            </h2>
            
            <p className="text-white/60 text-lg leading-relaxed mb-8 max-w-lg">
              O sistema definitivo para representantes comerciais de autopeças. 
              <span className="text-[#00ff88]"> Cálculos tributários automatizados</span>, 
              IA para recuperação de clientes, 
              dashboards de performance e 
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {[
                { icon: "⚡", text: "IPI e ST em milissegundos" },
                { icon: "🧠", text: "IA para retenção de clientes" },
                { icon: "📊", text: "Dashboards de Sell-Out" },
                { icon: "⏳", text: "Histórico de até 5 anos" },
              ].map((feature, i) => (
                <div key={i} className="flex items-center gap-3 p-3 border border-white/5 bg-white/[0.02] hover:border-[#00ff88]/30 transition-colors">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/salesmaster"
                onClick={() => trackSaibaMaisClick('SalesMasters')}
                data-category="Sistemas"
                data-action-type="click_saiba_mais"
                data-product-name="SalesMasters"
                className="group relative inline-flex items-center gap-3 px-8 py-4 bg-[#00ff88] text-[#0a0a0a] font-black text-sm tracking-wider hover:bg-white transition-all"
              >
                CONHECER O SALESMASTERS
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-4 border border-white/20 text-white/80 hover:text-[#00ff88] hover:border-[#00ff88] font-bold text-sm tracking-wider transition-all"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
          ...
          <div className={`relative transform transition-all duration-700 delay-300 ${isVisible ? "translate-x-0 opacity-100" : "translate-x-20 opacity-0"}`}>
            <div className="relative">
              {/* Big decorative text */}
              <div className="text-[12rem] md:text-[16rem] font-black text-transparent leading-none select-none" style={{ WebkitTextStroke: "1px rgba(0,255,136,0.2)" }}>
                SM
              </div>
              
              {/* Overlay card */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-8 border border-[#00ff88]/20 bg-[#0a0a0a]/90 backdrop-blur-sm">
                <div className="text-7xl mb-4">🚗</div>
                <h3 className="text-2xl font-black text-white mb-2">Autopeças</h3>
                <p className="text-white/50 text-sm leading-relaxed">
                  Linha leve, pesada e agrícola. Controle total de cotações, pedidos e comissões com inteligência tributária embarcada.
                </p>
                <div className="mt-6 flex items-center gap-4">
                  <div className="text-center">
                    <div className="text-3xl font-black text-[#00ff88]">100+</div>
                    <div className="text-white/40 text-xs">Clientes</div>
                  </div>
                  <div className="w-px h-10 bg-white/10" />
                  <div className="text-center">
                    <div className="text-3xl font-black text-white">20+</div>
                    <div className="text-white/40 text-xs">Anos</div>
                  </div>
                  <div className="w-px h-10 bg-white/10" />
                  <div className="text-center">
                    <div className="text-3xl font-black text-[#ff0033]">5</div>
                    <div className="text-white/40 text-xs">Pilares</div>
                  </div>
                </div>
              </div>
            </div>
